        ...
        <form action="{{ route('services.index') }}" method="GET" class="flex items-center gap-2">
          ...
          @if (request('search'))
            <a href="{{ route('services.index') }}"
              class="px-4 py-2 text-sm rounded-base bg-gray-100 text-gray-700 hover:bg-gray-200 transition">
              Reset
            </a>
          @endif
        </form>
          ...
          <div class="bg-white rounded-sm shadow-sm overflow-hidden">
            ...
            <div class="relative h-48 bg-gray-100">
              @if ($service->cover_path)
                <img src="{{ asset('storage/' . $service->cover_path) }}" alt="{{ $service->service_name }}"
        ...
        @empty
          <div class="col-span-1 md:col-span-2 lg:col-span-3 bg-white p-12">
            <div class="flex flex-col items-center justify-center text-center">
              ...
              <p class="text-gray-500 text-lg font-medium">Tidak ada layanan ditemukan</p>

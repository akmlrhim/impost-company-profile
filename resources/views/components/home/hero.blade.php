<section id="home" class="relative min-h-screen flex items-center bg-cover bg-center bg-no-repeat"
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
    <h1
      class="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight mb-6 bg-linear-to-r from-impost-primary via-impost-secondary to-impost-fourth bg-clip-text text-transparent">
      Your Expert Partner in<br class="hidden md:block">
      Digital, Event, and Business Solutions
    </h1>

    <p class="text-base md:text-lg text-gray-200 max-w-2xl mx-auto mb-10">
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-4">
      <a href="#"
        class="inline-flex items-center justify-center px-8 py-3 rounded-lg font-medium text-white bg-linear-to-r from-impost-primary via-impost-third to-impost-fourth transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        Mulai Sekarang
      </a>

      <a href="#"
        class="inline-flex items-center justify-center px-8 py-3 rounded-lg font-medium border border-white/80 text-white transition-all duration-300 hover:bg-white hover:text-gray-900">
...
<section class="py-16 bg-impost-fifth/55">
  <div class="max-w-7xl mx-auto px-6">
    <p class="text-center text-sm uppercase tracking-widest text-impost-primary font-medium mb-10">
      Dipercaya oleh berbagai brand
    </p>

    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-10 items-center justify-items-center text-gray-400">
      ...
      <a href="#" class="transition hover:text-gray-900 dark:hover:text-white">
        <svg class="h-8" ...></svg>
      </a>

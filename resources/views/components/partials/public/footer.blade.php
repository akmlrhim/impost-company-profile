<footer class="p-4 sm:p-6 bg-impost-fourth" id="contact">
  <div class="mx-auto max-w-7xl">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <div>
        <a href="#home" class="flex items-center mb-4">
          <img src="{{ asset('img/logo_impost_putih.png') }}" class="ml-6 h-16 scale-200 w-auto" alt="IMPOST Logo"
            loading="lazy" />
        </a>
        ...
        <div class="text-sm text-white">
          ...
          <p class="mb-3">Toko, Jl. Kawamara No.3, Landasan Ulin Tengah, Kec. Liang Anggang, Kota Banjar Baru,
      ...
      <div>
        <h2 class="mb-4 text-sm font-semibold text-white uppercase">Lokasi Kantor Kami</h2>
    ...
    <hr class="my-12 border border-white lg:my-12" />

    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-white sm:text-center">© 2025 <a href="#" class="hover:underline">CV Impost Media
          Indonesia</a>
      </span>

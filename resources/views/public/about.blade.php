  ...
  <div class="pt-16">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="max-w-3xl mx-auto text-center mb-14">
        ...
        {{-- about  --}}
        <span class="text-lg font-semibold tracking-widest text-impost-primary uppercase">
          Tentang Kami
        </span>
        <h1 class="mt-3 text-4xl sm:text-5xl font-bold text-white leading-tight">
          Impost Media Indonesia
        </h1>
        <div class="mt-6 mx-auto w-16 h-1 bg-impost-primary rounded-full"></div>
      </div>
      ...
      <div class="mt-16 max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div class="bg-gray-900/60 border border-gray-800 rounded-2xl p-8">
            <h3 class="text-2xl font-semibold text-impost-primary mb-4 flex items-center gap-2">
              Visi
            </h3>
          ...
          <div class="bg-gray-900/60 border border-gray-800 rounded-2xl p-8">
            ...
            <ol class="space-y-3 text-sm text-gray-300 leading-relaxed list-decimal list-outside pl-5">
              <li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          ...
          <div class="p-6">
            <div class="w-36 h-36 mx-auto mb-4 rounded-full overflow-hidden border-2 border-white">
            ...
            <div class="text-center">
              <h3 class="text-lg font-bold text-white">Sarah Johnson</h3>
              <p class="text-xs text-white font-medium mb-3">Chief Executive Officer</p>

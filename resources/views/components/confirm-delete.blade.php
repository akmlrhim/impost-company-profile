    ...
    <div class="relative w-full max-w-md bg-neutral-primary-soft border border-default rounded-base shadow-sm p-6">
      ...
      <div class="flex justify-center gap-4">
        <button type="button" data-modal-hide="{{ $modalId }}"
          class="px-4 py-2.5 text-sm rounded-base bg-neutral-secondary-medium hover:bg-neutral-tertiary-medium cursor-pointer">
          Batal
        </button>
        ...
        <form method="POST" id="confirmDeleteForm">
          ...
          @method('DELETE')
          <button type="submit"
            class="px-4 py-2.5 text-sm rounded-base bg-danger text-white hover:bg-danger-strong cursor-pointer">
            Ya, Hapus
          </button>
        </form>
      </div>

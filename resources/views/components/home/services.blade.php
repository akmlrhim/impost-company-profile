<section id="services">
  <div class="py-2 px-4 mx-auto max-w-7xl sm:py-4 lg:px-6">

    <!-- heading -->
    <div class="mb-8 space-y-4 text-center">
      <h2
        class="text-xl sm:text-2xl lg:text-4xl font-bold pb-1 bg-linear-to-r from-impost-primary via-impost-secondary to-impost-fourth bg-clip-text text-transparent">
        Layanan Kami
      </h2>
    ...
    <div x-data="{
      ...
      <div class="md:hidden">
        ...
        <div x-ref="slider" class="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-3 pb-1 scroll-smooth"
          ...
          ">
          @foreach ($servicesForMobile as $s)
            <div class="w-full shrink-0 snap-center px-6">
              <div
                ...
                <div class="h-48 overflow-hidden">
                  <img
                    src="{{ $s->cover_path ? asset('storage/' . $s->cover_path) : asset('img/service_default.webp') }}"
      ...
      <div class="hidden md:block">
        <div id="services-desktop" class="grid grid-cols-2 lg:grid-cols-3 gap-6">
          @foreach ($servicesForDesktop as $s)
            <div
